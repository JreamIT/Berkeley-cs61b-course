...
public class LinkedListDeque61B<TempHold> implements Deque61B<TempHold> {
    ...
    public Iterator<TempHold> iterator() {
        return new LinkedListDequeIterator();
    }

    private class LinkedListDequeIterator implements Iterator<TempHold> {
        private IntNode currNode;
        ...
        @Override
        public TempHold next() {
            TempHold result = currNode.item;
